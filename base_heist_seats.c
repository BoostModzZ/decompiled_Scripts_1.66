...
void func_11() // Position - 0x213
{
	...
	if (Global_1853753 == unk_0x259BE71D8A81D4FA() && !IS_BIT_SET(Global_1890444[unk_0x383461852896D73D() /*129*/].f_38.f_27, 5))
	{
		...
		if (func_18(&uLocal_47, false, false))
		{
			...
			if (iLocal_484 == 0 && !IS_BIT_SET(Global_1890444[unk_0x383461852896D73D() /*129*/].f_38.f_27, 3) && !func_16() && !unk_0x4D9174D8796EA622() && !func_15(0) && !func_14() && unk_0xDEE3EFEA31A1F555(0, 225))
				func_12(&uLocal_47);
		}
		else
		{
...
void func_19(var uParam0) // Position - 0x428
{
	...
	switch (uParam0->f_421.f_4)
	{
		...
		case 4:
			...
			if (num != 3)
			{
				unk34 = { unk_0xBE8776D2466E9EA6(&unk, &unk17, func_45(uParam0), func_44(uParam0), 0, 2) };
				unk37 = { unk_0x7A6103DCF5EE8CC3(&unk, &unk17, func_45(uParam0), func_44(uParam0), 0, 2) };
				unk40 = unk37.f_2;
...
void func_26(var uParam0) // Position - 0xA57
{
	...
	if (uParam0->f_421.f_4 == 6)
	{
		...
		else
		{
			...
			if (!unk_0x4D9174D8796EA622() && !func_8(&(uParam0->f_421), 0) && !func_8(&(uParam0->f_421), 4) && !func_29() && !func_27(true) && uParam0->f_421.f_8.f_2 != 3)
			{
...
BOOL func_53(var uParam0) // Position - 0x15A0
{
	...
	for (i = 0; i < unk_0x95C7A22DBE7AEF4C(); i = i + 1)
	{
		if (unk_0x7206AEB20960CCC8(unk_0xF0C9E5565CB32F4B(i)))
		{
			...
			if (unk != unk_0x259BE71D8A81D4FA() && _NETWORK_IS_PLAYER_VALID(unk, true, true) && func_56(unk_0x56E414973C2A8C0E(unk), &uParam0->[uParam0->f_421.f_2 /*14*/]))
				return 1;
		}
	}
...
BOOL func_78(var uParam0, int iParam1) // Position - 0x1F7F
{
	...
	if (func_81(unk_0x259BE71D8A81D4FA()) || IS_BIT_SET(iLocal_484, 0))
		return false;
