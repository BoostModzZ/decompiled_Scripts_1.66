...
void main() // Position - 0x0
{
	...
	func_236(&num);
	uLocal_92 = unk_0xA7B0B03284E7503C(unk61 - { 20f, 20f, 20f }, unk61 + { 20f, 20f, 20f }, 0, 1, 1, 1);
			...
			if (num == 35)
			{
				if (iLocal_93 == 0)
				{
					if (!unk_0x116053132936EA1F(joaat("DOORHASH_T_TRAILER_CS")))
						unk_0xB80B2E08713B8BC6(joaat("DOORHASH_T_TRAILER_CS"), joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, 1, 0);
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_207(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_210(var uParam0, int iParam1) // Position - 0xDE9A
{
	...
	{
		if (func_221(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
{
	return func_212(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}
...
BOOL func_216(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE224
{
	...
	unk = { func_218(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_218(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };
...
BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE633
{
	...
	unk = { func_218(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
