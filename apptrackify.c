...
void func_10() // Position - 0x3DF
{
	...
	if (func_18() == 0)
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		{
			uLocal_20 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
			...
			if (iLocal_31 == 0)
			{
				...
				{
					unk_0x330108B080A2132F(SYSTEM::FLOOR(fLocal_27));
					unk_0x330108B080A2132F(SYSTEM::FLOOR(fLocal_28));
				}
	...
	else if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
	{
		...
		for (i = 0; i < Global_4542572; i = i + 1)
		{
			...
			if (iLocal_31 == 0)
			{
				...
				unk_0x74BF156C860580D4(fLocal_30);
				unk_0x330108B080A2132F(Global_4542550[i]);
				unk_0xE6B753D52F4CA222();
			}
