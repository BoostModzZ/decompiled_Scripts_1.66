...
void func_153() // Position - 0xB2B8
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			if (func_154(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD290
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_197(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_196(uParam0, 1);
			}
			else
			{
				...
				if (func_197(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_199(uParam0);
			}
		}
	}
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD601
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_197(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_218(var uParam0, int iParam1) // Position - 0xE667
{
	...
	{
		if (func_229(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
{
	return func_220(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}
...
BOOL func_224(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE9F1
{
	...
	unk = { func_226(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_226(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };
...
BOOL func_233(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEE00
{
	...
	unk = { func_226(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_246(var uParam0) // Position - 0xF23C
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&num) || !unk_0xE100DD4F82A51BDE(str))
				return false;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (func_131(uParam0->f_28[0]))
			{
				...
				{
					func_247(&uParam0->f_41[3], num[1], unk_0x0D1381B6E0F3987D(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
			{
				...
				unk_0x381D671BCFC294D9(uParam0->f_41[0], uLocal_94, "idle_closed_pap_3_rcm_dumpster", str, 8f, -8f, 0, 1148846080);
				unk_0xBF3497E24DEAD835(uLocal_94, 1);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
					unk_0x3DA436E63AB0F541(uParam0->f_28[0], uLocal_94, str, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[1]))
					unk_0x381D671BCFC294D9(uParam0->f_41[1], uLocal_94, "idle_closed_pap_3_rcm_lid_l", str, 8f, -8f, 0, 1148846080);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[2]))
					unk_0x381D671BCFC294D9(uParam0->f_41[2], uLocal_94, "idle_closed_pap_3_rcm_lid_r", str, 8f, -8f, 0, 1148846080);
			}
...
BOOL func_259(var uParam0) // Position - 0x10129
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&num) || !unk_0xE100DD4F82A51BDE("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (func_131(uParam0->f_28[0]))
			{
				if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[0]))
				{
					func_247(&uParam0->f_41[0], num[2], unk_0x0D1381B6E0F3987D(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
