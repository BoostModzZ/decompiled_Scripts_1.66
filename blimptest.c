...
void func_1() // Position - 0x116
{
	...
	if (unk_0xFC8BFE4B41177C22(uLocal_40))
	{
		if (unk_0x1C2F771CDC87A3A5(uLocal_40, 0) || unk_0x8D91ADE44AC79BC9(uLocal_40) <= 0 || unk_0x4C7724D572378B05(uLocal_40) <= 0f)
		{
			...
			if (iLocal_47 == 1)
			{
				unk = { unk_0xD1A6A821F5AC81DB(uLocal_40, 0) };
				func_8(unk);
			}
...
void func_17() // Position - 0x68C
{
	...
	uLocal_40 = unk_0x5779387E956077A6(iLocal_41, unk_0x763EEC52E292B5A0(unk_0x95610E68DFCFC225(1, "Blimp_City"), 0f), unk.f_2, 1, 1, 0);
