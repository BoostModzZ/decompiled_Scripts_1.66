...
void main() // Position - 0x0
{
	...
	uLocal_94 = unk_0xA7B0B03284E7503C(-103.0011f, -1281.6357f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_204(-72.323f, -1258.643f, 28.648f, unk_0xD1A6A821F5AC81DB(num.f_35[0], 1), 1056964608))
			{
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_187() || Global_32166 || func_186() || func_185(8, -1) || func_183() || func_96() || func_184() || func_182() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_187() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_185(8, -1) || func_182() || func_181() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
int func_188(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCD57
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_192(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCF45
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_192(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_196(uParam0, 1);
			}
			else
			{
				...
				if (func_192(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_198(uParam0);
			}
		}
	}
...
BOOL func_242(var uParam0) // Position - 0xECB4
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_249(&num) || !unk_0xE100DD4F82A51BDE(str))
				return false;
