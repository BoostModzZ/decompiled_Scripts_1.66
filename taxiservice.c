...
void main() // Position - 0x0
{
	...
	iLocal_107 = -1;
	iLocal_108 = -1;
	uLocal_109 = unk_0xE934399D6F2C3AC5(2, 195, 1);
		...
		if (num > 0)
		{
			...
			if (!unk_0x4FAFF4BCB7633475(unk2))
			{
				...
				if (!unk_0x1C2F771CDC87A3A5(Global_112679, 0))
					if (unk_0xCECDBB848D53DEB2(unk2, Global_112679, 0))
						unk_0x23EB5FC236231892(unk2, Global_112679, 64);
			}
...
void func_13(int iParam0) // Position - 0xF91
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_15() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113648.f_20566.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_15() /*5568*/].f_681.f_10), iParam0);
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x120F
{
	...
	bParam4;
	num = Global_2805029[empsParam0 /*3*/][func_17(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x1463
{
	...
	{
		iParam2 == 0;
		unk = Global_2805029[empsParam0 /*3*/][func_17(iParam1)];
...
void func_45() // Position - 0x1E84
{
	...
	if (!unk_0xD6F9DEE4765092A9(str))
	{
		...
		func_48(unk_0x4A8C381C258A124D(), str, 7);
...
char* func_46() // Position - 0x1ED0
{
	...
	TEXT_LABEL_ASSIGN_STRING(&unk, unk_0xDAEDE051F3F4FD45(func_47(uLocal_43)), 32);
	...
	if (func_226())
	{
		...
		switch (iLocal_951)
		{
			case 0:
				if (!unk_0x4FAFF4BCB7633475(Global_112680) && unk_0xD9F5E1FEFD1329E4(Global_112679, 0))
					if (unk_0xF4244288C3EF3306(Global_112680, Global_112679))
						if (!unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_enter", 3) && !unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_idle", 3))
	...
	if (!func_219())
	{
		if (unk_0xA0C7B98BCF1EEF9E(uLocal_114))
		{
			if (iLocal_951 != 0)
			{
				...
				if (!unk_0x1B79E937E91F40C3(uLocal_109, unk))
				{
					uLocal_109 = unk;
					bLocal_60 = true;
				}
			...
			for (i = 0; i < uParam2->f_693; i = i + 1)
			{
				if (IS_BIT_SET(uParam2->f_689, i))
				{
					...
					if (!IS_BIT_SET(uParam2->f_690, i))
					{
						...
						func_69(unk_0xE934399D6F2C3AC5(unk, unk2, 1));
					
						if (num < 363)
							func_69(unk_0xE934399D6F2C3AC5(unk, num, 1));
					}
					else
					{
						unk3 = uParam2->f_1[i /*57*/].f_54;
						unk4 = uParam2->f_1[i /*57*/].f_55;
						func_69(unk_0xF761D79754BC3043(unk3, unk4, 1));
					}
	...
	switch (iLocal_953)
	{
		...
		case 1:
			if (unk_0x15CCE8886267624F() && unk_0xBC2EE32DE886BD08("FADE_OUT_WORLD_250MS_SCENE"))
			{
				...
				{
					unk_0x51C8BEA2005931AB(&uLocal_111);
		...
		case 7:
			...
			if (flag)
			{
				...
				{
					bLocal_69 = false;
					unk_0xB1EAADCB692D69CE(Global_112686 + { 100f, 0f, 0f }, &num, 0, 0);
...
void func_81() // Position - 0x3E2E
{
	...
	switch (iLocal_826)
	{
		case 92:
			num = { func_83(229, 0) };
			value = unk_0xED977E2AE2CB16EE(Global_112686, num, 1);
			...
			if (value < 100f)
			{
				...
				unk_0x813ADF2A2A03F440(num, &Global_112686, &Global_112692, 1, 1077936128, 0);
				unk_0xB2BD5837A8D3CEDA(Global_112679, Global_112686, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(Global_112679, Global_112692);
			}
			break;
...
void func_111(int iParam0) // Position - 0x5F09
{
	...
	while (!flag && num2 < 10)
	{
		...
		if (func_112(&num, vector, iParam0))
		{
			...
			if (unk_0x8B777C12D64DF209(Global_112686, num2, &vector, 1, 1077936128, 0))
				num2 = num2 + 1;
		}
	}

	if (SYSTEM::VDIST2(vector, Global_112686) > 2f)
		unk_0xC0EEE6A2207F3CB8(vector, 0, &Global_112686, 0);
...
void func_116() // Position - 0x613A
{
	...
	num = func_119(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), Global_112686);
...
void func_120() // Position - 0x62BC
{
	...
	value = (func_119(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), Global_112686) / 50f) * fLocal_75 * 2.4f;
...
{
	iLocal_105 = iLocal_105 + SYSTEM::ROUND(unk_0x0B852B0BF94A8DC1() * 1000f);
	...
	if (unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), uLocal_974, 0) > 50f)
	{
		fLocal_84 = fLocal_84 + fLocal_75;
		iLocal_105 = 0;
		uLocal_974 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0) };
	}
	...
	if (iLocal_103 != iLocal_104)
	{
		...
		unk_0xE6B753D52F4CA222();
		fLocal_85 = SYSTEM::VDIST(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), Global_112686);
...
void func_122() // Position - 0x63C2
{
	...
	if (!func_38(14))
	{
		unk = unk_0x1287CC087A5CE000(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Global_112686);
	...
	if (unk_0xC450B06E5AAA0985(*uParam0))
	{
		switch (iLocal_950)
		{
			case 0:
				...
				if (unk_0xC450B06E5AAA0985(Global_112684) && *uParam0 == Global_112684)
				{
			...
			case 2:
				...
				{
					if (func_125(&Global_112679, unk_0xD1A6A821F5AC81DB(Global_112679, 0), uLocal_962, fParam1, uParam2, &iLocal_90, uParam0, 1000))
					{
						iLocal_950 = 3;
						return false;
					}
...
int func_156(var uParam0, var uParam1, var uParam2) // Position - 0xC189
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_97614[i /*17*/])
		{
			if (Global_97614[i /*17*/].f_9 != 263)
			{
				if (unk_0xC450B06E5AAA0985(Global_32543[Global_97614[i /*17*/].f_9 /*23*/].f_19))
				{
					vector = { unk_0x3CF9D442F2C902BD(Global_32543[Global_97614[i /*17*/].f_9 /*23*/].f_19) };
	...
	if (unk_0xDC469CE2BE7CE722(func_6()))
	{
		...
		if (num > 0)
		{
			if (num > 1)
			{
				...
				if (!unk_0x4FAFF4BCB7633475(unk2))
				{
					if (!unk_0xF4244288C3EF3306(unk2, Global_112679))
					{
						num2 = 0;
					
						if (!unk_0xC39AE5D390581AD5(Global_112679, num2, 0))
						{
							...
							{
								unk_0x974022927CB47E68(unk2);
								unk_0x73CAFD2038E812B3(unk2, Global_112679, num2);
							}
						}
						else
						{
...
void func_169() // Position - 0xC628
{
	...
	if (!unk_0x4FAFF4BCB7633475(Global_112680) && unk_0xD9F5E1FEFD1329E4(Global_112679, 0))
	{
		if (unk_0xF4244288C3EF3306(Global_112680, Global_112679))
		{
			...
			{
				unk = { unk_0xD1A6A821F5AC81DB(Global_112679, 1) };
				unk4 = unk_0xCFC0C995455A6204(Global_112679);
				unk_0x2D864CC37DDFA963(Global_112680, Global_112679, unk, unk4, 3, 60f, 0);
			}
		}
	}
		...
		if (bLocal_63)
		{
			...
			if (unk_0xD9F5E1FEFD1329E4(Global_112679, 0))
			{
				if (!unk_0x4FAFF4BCB7633475(Global_112680))
				{
					...
					else if (unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_enter", 3) || unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_idle", 3))
					{
						if (unk_0x9E437CA2E2CAD79D(Global_112680, unk_0x4A8C381C258A124D()))
							unk_0x84B06A81C98DA4B8(Global_112680);
					
						unk_0x10425721983AE158(Global_112680, &uLocal_954, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_exit", 3))
					{
						unk_0x458AA1A01F53901E(Global_112680, &uLocal_954, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_112680, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
					{
						...
						else
						{
							...
							unk_0x6C33493626F3C0D1(0, Global_112679, Global_112686, num2, num, 45f);
...
BOOL func_171(var uParam0, int iParam1) // Position - 0xC8FF
{
	...
	if (!unk_0x4FAFF4BCB7633475(num3))
	{
		...
		flag = true;
		num2 = unk_0xFD5C5BBD1FE92BB7(Global_112679, num4, 0);
		...
		if (flag)
		{
			unk_0xEBA229B2E0BB05E0(num3, Global_112679, 20000, num4, 2f, 9437185, 0);
			flag2 = true;
		}
	}
	...
	if (unk_0xDC469CE2BE7CE722(func_6()))
	{
		...
		if (num > 0)
		{
			...
			if (!unk_0x4FAFF4BCB7633475(num2))
			{
				...
				if (flag)
					unk_0xEBA229B2E0BB05E0(num2, *iParam0, 20000, num4, 2f, 9437185, 0);
			}
	...
	if (!unk_0x4FAFF4BCB7633475(Global_112680) && unk_0xD9F5E1FEFD1329E4(Global_112679, 0))
	{
		if (unk_0xF4244288C3EF3306(Global_112680, Global_112679))
		{
			...
			if (unk_0xE100DD4F82A51BDE(&uLocal_954))
			{
				...
				unk_0xB5396F1FB088FE38(&uLocal_815);
				unk_0x10425721983AE158(0, &uLocal_954, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
				unk_0x10425721983AE158(0, &uLocal_954, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
				unk_0x93C0674FC00824D0(uLocal_815);
				unk_0x4BD42B0527065BB6(Global_112680, uLocal_815);
				unk_0xD0557B139A542F12(&uLocal_815);
				return 1;
...
BOOL func_176() // Position - 0xCD19
{
	...
	if (unk_0xFC8BFE4B41177C22(Global_112679))
	{
		if (unk_0xD9F5E1FEFD1329E4(Global_112679, 0))
		{
			uLocal_111 = unk_0x4E55EAB577C13329(iLocal_110, unk_0xD1A6A821F5AC81DB(Global_112679, 1), 1, 1, 0);
			unk_0x4D306DD94DD6FDBA(uLocal_111, Global_112679, unk_0x365DC1E8054AF31A(Global_112679, "Chassis"), uLocal_986, uLocal_989, 0, 0, 0, 0, 2, 1, 0);
			unk_0x0B29D0B41AC20799(Global_112679, 0);
		
			if (!unk_0xC13AFEAFC3F7AD96("taxi" /*Taxi*/))
			{
				unk_0x106F99CDCDEED9A0("taxi" /*Taxi*/, 0);
				unk_0xF1C26EB47E689774(unk_0x4B423FAA24E8ABF0(uLocal_111));
			}
		
			uLocal_95 = unk_0x08732C0099FA1813("taxi" /*Taxi*/);
		}
	}
...
BOOL func_177() // Position - 0xCDB4
{
	...
	if (unk_0x6252BC0DD8A320DB(iLocal_110) && unk_0xA0C7B98BCF1EEF9E(uLocal_113) && unk_0xA0C7B98BCF1EEF9E(uLocal_114) && unk_0xE100DD4F82A51BDE(&uLocal_954))
		return true;
...
void func_178() // Position - 0xCE0D
{
	...
	if (!unk_0x78411E34CF90EA8C(uLocal_70))
	{
		if (!func_186() && !func_185(8, -1))
		{
			...
			unk_0x03F10D56CCA2C055(uLocal_70, Global_112679, uLocal_980, 1);
			func_182();
...
void func_180() // Position - 0xCF72
{
	...
	{
		unk = { unk_0x3CF9D442F2C902BD(uLocal_43) };
...
void func_183(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD045
{
	...
	if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
	{
		if (unk_0x78411E34CF90EA8C(*uParam1))
		{
			...
			unk6 = unk.f_1;
			unk7 = { func_82(unk_0x0D1381B6E0F3987D(Global_112679, uParam2) - unk_0x0D1381B6E0F3987D(Global_112679, uLocal_980)) };
...
void func_187() // Position - 0xD198
{
	...
	for (i = 0; i < iLocal_93; i = i + 1)
	{
		if (!unk_0xC450B06E5AAA0985(uLocal_829[i /*3*/]))
		{
		}
		else if (func_127(uLocal_829[i /*3*/]) == -1)
		{
		}
		else if (func_131(unk_0x3CF9D442F2C902BD(uLocal_829[i /*3*/]), 0f, 0f, 0f, 1056964608, false))
		{
		}
		else
		{
			...
			unk_0x330108B080A2132F(i);
			unk_0x330108B080A2132F(unk_0x8FACE824AEC046E8(uLocal_829[i /*3*/]));
			unk_0xA306E6FD2A6558E6(unk_0x2B91B956D741B8CE(uLocal_829[i /*3*/]), &unk, &unk2, &unk3, &unk4);
			...
			if (num == -1)
			{
				...
				unk_0x273F00982486DCC6(uLocal_829[i /*3*/]);
				unk_0xCFAD3D478C87321A();
			}
			else
			{
				unk_0x882AEFD55B8D51FB("STRING");
				unk_0xACF853FB3F6EA7D4(func_188(num));
				unk_0xCFAD3D478C87321A();
			}
		
			if (unk_0x6AEAF32EC173BB39(uLocal_829[i /*3*/]) == 2)
				if (!unk_0x4FAFF4BCB7633475(unk_0xBD545F8729E9F413(unk_0xA143F1936B350BD0(uLocal_829[i /*3*/]))))
					unk5 = { unk_0xD1A6A821F5AC81DB(unk_0xBD545F8729E9F413(unk_0xA143F1936B350BD0(uLocal_829[i /*3*/])), 1) };
			else if (unk_0x6AEAF32EC173BB39(uLocal_829[i /*3*/]) == 1)
				if (unk_0xD9F5E1FEFD1329E4(unk_0xA143F1936B350BD0(uLocal_829[i /*3*/]), 0))
					unk5 = { unk_0xD1A6A821F5AC81DB(unk_0xA143F1936B350BD0(uLocal_829[i /*3*/]), 1) };
			else
				unk5 = { unk_0x3CF9D442F2C902BD(uLocal_829[i /*3*/]) };
		
			func_68(unk_0xDAEDE051F3F4FD45(unk5));
			...
			if (uLocal_829[i /*3*/].f_2 == 0)
			{
				if (uLocal_829[i /*3*/].f_1 != 0)
				{
					...
					unk_0xD4006E065B0782FA(uLocal_829[i /*3*/].f_1);
					unk_0xCFAD3D478C87321A();
				}
			}
			else
			{
				...
				unk_0xD4006E065B0782FA(uLocal_829[i /*3*/].f_1);
				unk_0xD4006E065B0782FA(uLocal_829[i /*3*/].f_2);
				unk_0xCFAD3D478C87321A();
			}
...
void func_192() // Position - 0xE180
{
	...
	func_196(117, true);
	iLocal_96 = func_193();
	uLocal_97 = unk_0xC802478C8862BDAD();
...
int func_193() // Position - 0xE5FA
{
	...
	for (i = unk_0xD56419CB9E15983F(iLocal_46); unk_0xC450B06E5AAA0985(i); i = unk_0xA3F6143A8F610118(iLocal_46))
	{
		if (func_195(i))
		{
	...
	for (i = unk_0xD56419CB9E15983F(iLocal_47); unk_0xC450B06E5AAA0985(i); i = unk_0xA3F6143A8F610118(iLocal_47))
	{
		if (func_195(i))
...
void func_198(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xECA1
{
	...
	if (func_127(uLocal_829[iParam3 /*3*/]) == unk_0x2A3612A4B836469E())
	{
		iLocal_99 = iParam3;
		uLocal_977 = { unk_0x3CF9D442F2C902BD(uLocal_829[iParam3 /*3*/]) };
	}
...
float func_202(var uParam0) // Position - 0xED7F
{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		if (unk_0xC450B06E5AAA0985(uParam0))
			vector = { func_47(uParam0) - unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
...
BOOL func_206(var uParam0) // Position - 0xEEED
{
	...
	if (func_207(unk_0x3CF9D442F2C902BD(*uParam0), 0f, 0f, 0f, false))
		return true;
...
BOOL func_210() // Position - 0xEFF7
{
	...
	if (!unk_0xC450B06E5AAA0985(uLocal_829[iLocal_94 /*3*/]))
	...
	if (SYSTEM::TIMERB() > 250)
	{
		if (!flag)
		{
			if (uLocal_97 != unk_0xC802478C8862BDAD())
				flag = true;
		...
		if (!flag)
		{
			if (iLocal_99 != -1)
			{
				if (unk_0xC450B06E5AAA0985(uLocal_829[iLocal_99 /*3*/]))
				{
					if (func_127(uLocal_829[iLocal_99 /*3*/]) == unk_0x2A3612A4B836469E())
					{
						unk = { unk_0x3CF9D442F2C902BD(uLocal_829[iLocal_99 /*3*/]) };
			...
			if (iLocal_951 == 2)
			{
				...
				if (!bLocal_66)
				{
					if (unk_0x875A214D5EBCA509(2, 179))
					{
						...
						if (!unk_0x4FAFF4BCB7633475(Global_112680))
							if (!unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_enter", 3))
								if (!unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_idle", 3))
									if (!unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_exit", 3))
										unk_0x974022927CB47E68(Global_112680);
					}
				}
...
void func_215() // Position - 0xF523
{
	...
	if (unk_0xC450B06E5AAA0985(uLocal_829[iLocal_94 /*3*/]))
	{
		unk = { unk_0x3CF9D442F2C902BD(uLocal_829[iLocal_94 /*3*/]) };
...
BOOL func_228(int iParam0) // Position - 0xF9A2
{
	...
	if (_GET_PLAYER_CHARACTER_FROM_PED(unk_0x4A8C381C258A124D()) != echLocal_73)
		return true;
	...
	if (iLocal_951 != 4)
	{
		...
		unk = { unk_0xD1A6A821F5AC81DB(Global_112679, 0) };
...
BOOL func_230() // Position - 0xFB43
{
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		if (func_234(&unk, func_236(), func_235()))
		{
			...
			{
				uLocal_971 = { unk_0xD1A6A821F5AC81DB(Global_112679, 1) - unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
				uLocal_971.f_2 = 0f;
				fLocal_74 = SYSTEM::VMAG(uLocal_971);
				echLocal_73 = _GET_PLAYER_CHARACTER_FROM_PED(unk_0x4A8C381C258A124D());
				func_231();
				iLocal_98 = func_211();
				bLocal_60 = true;
				unk_0x66EFB3D6110055C4(0, 75, 1);
...
void func_231() // Position - 0xFC27
{
	...
	if (unk_0xD9F5E1FEFD1329E4(Global_112679, 0))
	{
		if (!unk_0xC39AE5D390581AD5(Global_112679, 1, 0))
		{
			unk = unk_0xFD5C5BBD1FE92BB7(Global_112679, 1, 0);
		...
		if (!unk_0xC39AE5D390581AD5(Global_112679, 2, 0))
		{
			unk = unk_0xFD5C5BBD1FE92BB7(Global_112679, 2, 0);
			...
			if (!unk_0x4FAFF4BCB7633475(*uParam1))
			{
				if (unk_0xF4244288C3EF3306(*uParam1, *uParam0))
				{
					...
					if (bParam2)
					{
						...
						TEXT_LABEL_ASSIGN_STRING(&Global_112710, unk_0x1AF90EB93E0012D6(), 24);
					}
					else
					{
						...
						if (unk_0xD9F5E1FEFD1329E4(Global_112679, 0))
						{
							if (unk_0xF4244288C3EF3306(Global_112680, Global_112679))
							{
								if (unk_0x9B5C1660CCDF7189(Global_112680, joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 1 && unk_0x9B5C1660CCDF7189(Global_112680, joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 0)
								{
									...
									unk_0x4BD42B0527065BB6(Global_112680, unk);
...
void func_237(BOOL bParam0) // Position - 0x100FA
{
	...
	{
		if (unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_enter", 3))
			unk_0x1D949F0AD44C7F05(Global_112680, "leanover_enter", &uLocal_954, -2f);
		else if (unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_idle", 3))
			unk_0x1D949F0AD44C7F05(Global_112680, "leanover_idle", &uLocal_954, -2f);
		else if (unk_0x13CCB1AD131C1082(Global_112680, &uLocal_954, "leanover_exit", 3))
			unk_0x1D949F0AD44C7F05(Global_112680, "leanover_exit", &uLocal_954, -2f);
