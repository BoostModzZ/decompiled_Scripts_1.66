...
BOOL func_131(int iParam0) // Position - 0x75F5
{
	...
	if (!func_132(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger") && !flag)
		return false;
...
BOOL func_133(var uParam0) // Position - 0x769F
{
...
BOOL func_134(var uParam0) // Position - 0x76CE
{
...
BOOL func_135(var uParam0) // Position - 0x777F
{
	int num;
...
BOOL func_136(int iParam0) // Position - 0x77F6
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_138(var uParam0, BOOL bParam1) // Position - 0x787F
{
	switch (unk_0x4B423FAA24E8ABF0(uParam0))
	{
...
int func_139(var uParam0) // Position - 0x78DA
{
	int i;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x7913
{
	if (iParam1 == 0)
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x7E1A
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_153(int iParam0, BOOL bParam1, var uParam2) // Position - 0x8301
{
	BOOL flag;
...
BOOL func_154(int iParam0) // Position - 0x874D
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_155(var uParam0, eCharacter echParam1) // Position - 0x8776
{
	var unk;
	int i;
	int j;
...
void func_156(var uParam0, var uParam1) // Position - 0x8978
{
	int i;
...
BOOL func_160(var uParam0) // Position - 0x8DA3
{
...
BOOL func_161(int iParam0) // Position - 0x8E80
{
	if (iParam0 == 0)
		return false;
...
BOOL func_162(int iParam0, BOOL bParam1, int iParam2) // Position - 0x9032
{
	int i;
	var unk;
...
BOOL func_163(int iParam0) // Position - 0x91B4
{
	int num;
	var unk;
	var unk2;
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x9297
{
	BOOL num;
	var unk;
...
BOOL func_173(var uParam0) // Position - 0xC9E1
{
	int num;
	var unk;
...
BOOL func_174(var uParam0) // Position - 0xCA28
{
	int i;
...
BOOL func_175(var uParam0) // Position - 0xCAA4
{
	int i;
...
eCharacter func_176(var uParam0) // Position - 0xCB8C
{
	int i;
...
BOOL func_177(var uParam0, int iParam1, BOOL bParam2) // Position - 0xCBEF
{
	int i;
	var unk;
	int num;
...
void func_179(var uParam0, eCharacter echParam1) // Position - 0xCD35
{
	int i;
...
BOOL func_181(var uParam0) // Position - 0xCDE2
{
...
BOOL func_183(var uParam0) // Position - 0xCFCB
{
	int i;
	int num;
	int num2;
...
int func_185(var uParam0, int iParam1) // Position - 0xD0FE
{
	int value;
	int value2;
	float num;
...
int func_186(var uParam0, int iParam1) // Position - 0xD1E7
{
	int i;
...
BOOL func_187(var uParam0, int iParam1, int iParam2) // Position - 0xD249
{
...
int func_192(eCharacter echParam0, int iParam1) // Position - 0xD5B1
{
	int num;
...
void func_193(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xD5F3
{
	int i;
...
var func_203(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF0E9
{
	return func_204(&(Global_107196.f_2890), uParam0, fParam3, false);
}

var func_204(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF103
{
	var unk;
	Vector3 vector;
	BOOL flag;
...
int func_205(var uParam0) // Position - 0xF3B5
{
	int i;
	var unk;
	var unk2;
...
BOOL func_206(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xF478
{
	int num;
	var unk;
	int num2;
...
BOOL func_207(var uParam0, var uParam1, BOOL bParam2) // Position - 0xF680
{
	var unk;
	var unk2;
	var unk3;
...
void func_208(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF6E1
{
	int num;
	int num2;
	int i;
...
void func_214(var uParam0, var uParam1) // Position - 0xFED0
{
	int num;
	int num2;
...
BOOL func_216(var uParam0) // Position - 0xFF59
{
	int num;
...
BOOL func_219(var uParam0) // Position - 0x1004C
{
...
int func_220(var uParam0) // Position - 0x100D3
{
...
BOOL func_223(int iParam0, BOOL bParam1) // Position - 0x10142
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x101A0
{
	var unk;
...
BOOL func_233(int iParam0) // Position - 0x103C9
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_247(var uParam0, var uParam1, var uParam2) // Position - 0x108BB
{
...
BOOL func_250(var uParam0) // Position - 0x10948
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x115F3
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x11623
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
BOOL func_296(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x153F5
{
	int num;
	int num2;
	eMPStat stat;
