...
void main() // Position - 0x0
{
	...
	else if (num == 30)
	{
		...
		uLocal_262 = unk_0x1DD05E817C89C737();
	}
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1))
		{
			if (num == 30)
			{
				if (func_222(unk_0x4A8C381C258A124D(), -1102.7241f, 290.1463f, 63.23002f, 1) < 200f)
				{
...
BOOL func_179(var uParam0) // Position - 0xC2B2
{
	if (*uParam0 == 29)
	{
		if (func_222(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			...
			else if (!func_180(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_153(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
int func_181(var uParam0) // Position - 0xC378
{
	if (*uParam0 == 28)
	{
		if (func_222(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			...
			else if (!func_180(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_153(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 4f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_196() || Global_32166 || func_195() || func_194(8, -1) || func_192() || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_196() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_194(8, -1) || func_191() || func_190() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
void func_197() // Position - 0xD5C3
{
	...
	{
		case 0:
			if (unk_0x1DD05E817C89C737() - uLocal_262 > 100 && bLocal_263 == false)
				iLocal_96 = 1;
			break;
...
int func_211(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDD3E
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_222(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_231(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_234(var uParam0, int iParam1) // Position - 0xF024
{
	...
	{
		if (func_245(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
{
	return func_236(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}
...
BOOL func_240(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF3AE
{
	...
	unk = { func_242(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_242(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };
...
BOOL func_249(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF7BD
{
	...
	unk = { func_242(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_276(var uParam0) // Position - 0x104BD
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_274(&num) || !unk_0xE100DD4F82A51BDE("rcmjosh3"))
				return false;
...
BOOL func_278(var uParam0) // Position - 0x106EB
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_274(&num) || !unk_0xE100DD4F82A51BDE("rcmjosh2"))
				return false;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				uLocal_94 = unk_0x2EC137C692A52458(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0xBF3497E24DEAD835(uLocal_94, 1);
				unk_0x3DA436E63AB0F541(uParam0->f_28[0], uLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
