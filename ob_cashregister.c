			...
			if (unk_0x71C1A46B17126AA4(uScriptParam_0))
			{
				switch (iLocal_18)
				{
					case 0:
						...
						{
							uLocal_19 = { unk_0xD1A6A821F5AC81DB(uScriptParam_0, 1) };
							iLocal_18 = 1;
						}
						break;
...
void func_1() // Position - 0x111
{
	...
	if (unk_0x76CD105BCAC6EB9F())
		func_2(num2, unk_0x165E2DDD2BD0F07D(uLocal_19, 1067030938, 1069547520), unk, num3, num, false, 0);
	else
		unk_0x8D4CAF9A056EA9E4(num2, unk_0x165E2DDD2BD0F07D(uLocal_19, 1067030938, 1069547520), unk, num3, 0, num);
