...
void main() // Position - 0x0
{
	...
	{
		unk_0x3CEA1FD137ACE2D9(uLocal_83.f_28[0], uLocal_328);
	...
	switch (iLocal_145)
	{
		case 0:
			...
			if (unk_0xE100DD4F82A51BDE("rcmjosh1leadinout") && unk_0x6252BC0DD8A320DB(joaat("p_amb_phone_01")))
			{
				if (!unk_0xFC8BFE4B41177C22(uLocal_147))
				{
					...
					uLocal_147 = unk_0x8366ABB82B1ABC59(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
				}
		...
		case 1:
			if (iLocal_158 == 1)
			{
				...
				if (unk_0x1DD05E817C89C737() - uLocal_159 >= 500)
				{
					func_235(1, 1, 1);
					iLocal_158 = 0;
				}
			...
			if (!bLocal_160)
			{
				if (func_297(uLocal_83.f_28[0]) && unk_0xFC8BFE4B41177C22(uLocal_147))
				{
					uLocal_149 = unk_0x2EC137C692A52458(uLocal_150, uLocal_153, 2);
					unk_0x3DA436E63AB0F541(uLocal_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					unk_0x381D671BCFC294D9(uLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
			...
			else if (unk_0x5266F1D2AEF6F73A(uLocal_149))
			{
				if (unk_0xBD3B265153D3BA2D(uLocal_149) > 0.29f)
				{
					if (!bLocal_161)
					{
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_163, 2, unk_0x4A8C381C258A124D(), "Trevor", 0, 1);
				...
				if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -1107.1068f, 290.4275f, 62.9487f, -1102.038f, 291.34207f, 66.278946f, 2f, 0, 1, 0))
				{
					...
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					{
						unk_0x974022927CB47E68(uLocal_83.f_28[0]);
						_DEBUG_PRINT("Stopping Josh?");
					}
				
					if (unk_0xFC8BFE4B41177C22(uLocal_147))
						unk_0xC0086E5CBF13BBF7(uLocal_147, -8f, 1);
				
					iLocal_162 = 1;
				}
			
				if (func_218(uLocal_83.f_28[0], unk_0x4A8C381C258A124D(), 1) > 17.5f)
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					{
						unk_0xC0086E5CBF13BBF7(uLocal_83.f_28[0], -8f, 1);
						unk_0x974022927CB47E68(uLocal_83.f_28[0]);
					}
				...
				if (unk_0x4FAFF4BCB7633475(uLocal_83.f_28[0]) || unk_0x5B702A5D1F2635BE(uLocal_83.f_28[0]) || unk_0x8764A5B95AE1F967(-1, unk_0xD1A6A821F5AC81DB(uLocal_83.f_28[0], 1), 5f))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					{
						unk_0xC0086E5CBF13BBF7(uLocal_83.f_28[0], -8f, 1);
		...
		case 2:
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
			{
				...
				unk_0x4BD42B0527065BB6(uLocal_83.f_28[0], uLocal_146);
				unk_0xD0557B139A542F12(&uLocal_146);
				unk_0xAAA71DD7E9059338(uLocal_83.f_28[0], 0);
			
				if (iLocal_162 == 0)
					unk_0x717804C8C8DA67BF(uLocal_83.f_28[0], joaat("MotionState_Walk"), 0, 0, 1);
			}
...
void func_238(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28113
{
	...
	else
	{
		...
		if (unk_0x76CD105BCAC6EB9F())
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_242(unk_0x259BE71D8A81D4FA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x259BE71D8A81D4FA(), 0) && !func_239() && !bParam4 && !bParam5 && !unk_0xAD15761928FCF79C())
...
void func_247() // Position - 0x283B5
{
	...
	if (unk_0xB3FA103AA6383C28())
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
			unk_0x2F19C4305F0B8DA7("Josh", uLocal_83.f_28[0], 0);
	}
	...
	switch (iLocal_145)
	{
		case 0:
			if (func_263(1, 1093140480, 0))
			{
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					unk_0xF293D66D4452C854(uLocal_83.f_28[0], "Josh", 0, 0, 0);
		...
		case 1:
			...
			if (unk_0xD8FC13DA1BA1DBA2("Josh", 0))
			{
				...
				if (!bLocal_160)
				{
					...
					func_248(unk_0x4A8C381C258A124D(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, 1);
					unk_0xD815D4BD1AE9E85A(0f, 1065353216);
					unk_0x64BB72494B9DF6DC(0f);
					...
					{
						uLocal_149 = unk_0x2EC137C692A52458(uLocal_150, uLocal_153, 2);
						unk_0x3DA436E63AB0F541(uLocal_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						unk_0x381D671BCFC294D9(uLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						_DEBUG_PRINT("Done Josh leadout anim on Josh exit state");
						unk_0x2B2ECB6F6371E59E(uLocal_147);
						unk_0x717804C8C8DA67BF(uLocal_83.f_28[0], joaat("MotionState_Idle"), 0, 1, 1);
						bLocal_160 = true;
					}
				}
			}
			...
			if (!unk_0x0CB7695268A7F50F())
			{
				...
				if (!bLocal_160)
				{
					...
					{
						uLocal_149 = unk_0x2EC137C692A52458(uLocal_150, uLocal_153, 2);
						unk_0x3DA436E63AB0F541(uLocal_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						unk_0x381D671BCFC294D9(uLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
			...
			if (!_IS_MISSION_REPEAT_ACTIVE(false))
			{
				if (!bLocal_156)
				{
					if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, 0, 1, 0))
					{
						if (func_297(uLocal_83.f_28[0]) && unk_0xFC8BFE4B41177C22(uLocal_147))
						{
							uLocal_148 = unk_0x2EC137C692A52458(uLocal_150, uLocal_153, 2);
							unk_0x3DA436E63AB0F541(uLocal_83.f_28[0], uLocal_148, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							unk_0x381D671BCFC294D9(uLocal_147, uLocal_148, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
							unk_0xE67051907958B5EB(unk_0x4A8C381C258A124D(), uLocal_83.f_28[0], -1, 0, 2);
							unk_0xE67051907958B5EB(uLocal_83.f_28[0], unk_0x4A8C381C258A124D(), 4000, 2060, 2);
				...
				else if (unk_0x5266F1D2AEF6F73A(uLocal_148))
				{
					...
					if (func_218(unk_0x4A8C381C258A124D(), uLocal_83.f_28[0], 1) <= 2.5f)
					{
...
void func_273() // Position - 0x29DE7
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			if (func_269(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
BOOL func_291(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2A6B1
{
	...
	switch (Global_78813)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_278(0) || func_292(true))
			{
			}
			else
			{
...
void func_326(BOOL bParam0) // Position - 0x2B3E5
{
	...
	if (!func_343())
	{
		...
		{
			func_161(num, 1, 0);
			func_327(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_112735[num /*10*/].f_9 == -1)
