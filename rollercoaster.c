...
void main() // Position - 0x0
{
	...
	{
		uLocal_930 = unk_0x2CB6AB601EB7D2D9("DEFAULT_SCRIPTED_CAMERA", -1652.2273f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 1, 2);
		unk_0xA3774254665BAA82(uLocal_930, -1652.2273f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
	...
	if (unk_0x78411E34CF90EA8C(uLocal_930))
	{
		unk_0xA3774254665BAA82(uLocal_930, -1651.5007f, -1118.3954f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
	...
	if (func_56(unk_0x4A8C381C258A124D()) && func_56(uLocal_868.f_9))
	{
		unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), -1648.4f, -1127.6f, 18.3f, 1, 0, 0, 1);
		unk_0x4D306DD94DD6FDBA(unk_0x4A8C381C258A124D(), uLocal_868.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
		unk_0x4285E11B28063EE0(unk_0x4A8C381C258A124D(), 0, 0);
	}
	...
	if (func_56(unk_0x4A8C381C258A124D()))
	{
		...
		func_14(&uLocal_893, unk, unk_0x88124E0D60FB8D11(uLocal_868.f_9, 2), 50f, uLocal_893.f_20, uLocal_893.f_21, 3, 1101004800, 0, 0, -1082130432, false);
		unk_0x03F10D56CCA2C055(uLocal_893, unk_0x4A8C381C258A124D(), 0f, 0f, 0.5f, 1);
	}

	SYSTEM::WAIT(0);

	if (func_56(unk_0x4A8C381C258A124D()) && func_56(uLocal_880.f_9))
	{
		func_12(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(uLocal_880.f_9, 1), &num2, &num3, 1);
		func_9(&uLocal_893, true, true, false, false, 1045220557, false, 1065353216, false);
		unk_0x5E5CEC33463AD803(uLocal_893, { num3, 0f, num2 } + uLocal_893.f_14, 2);
	}
	...
	while (true)
	{
		...
		if (func_56(unk_0x4A8C381C258A124D()) && func_56(uLocal_880.f_9))
		{
			func_12(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(uLocal_880.f_9, 1), &num2, &num3, 1);
			func_9(&uLocal_893, true, true, false, false, 1045220557, false, 1065353216, false);
			unk_0x5E5CEC33463AD803(uLocal_893, { num3 + (num5 * num6 * 2f), 0f, num2 + num5 } + uLocal_893.f_14, 2);
		}
...
void func_6() // Position - 0x833
{
	...
	num = SYSTEM::TO_FLOAT(unk_0x510D0699BE9C6D06(iLocal_941[iLocal_940 + 1 /*3*/] - iLocal_941[iLocal_940 /*3*/]));
...
void func_29() // Position - 0x185B
{
	...
	iLocal_925[0] = unk_0x8366ABB82B1ABC59(-1643.5242f, -1124.6805f, 17.4326f, 2f, joaat("prop_roller_car_01"), 1, 0, 1);
	iLocal_925[1] = unk_0x8366ABB82B1ABC59(-1645.1455f, -1126.6127f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_925[2] = unk_0x8366ABB82B1ABC59(-1646.7676f, -1128.5453f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_925[3] = unk_0x8366ABB82B1ABC59(-1648.3896f, -1130.4784f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);

	for (i = 0; i < iLocal_925; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_925[i]))
		{
			unk_0xEE0BCDB1B5E36BCB(iLocal_925[i], 1, 0);
			unk_0x4285E11B28063EE0(iLocal_925[i], 0, 0);
			unk_0x44C48AC14D3C09ED(iLocal_925[i], 0, 0);
			unk_0x935364B4448CD584(iLocal_925[i], 1);
		}
	}
...
int func_61(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3E21
{
			...
			if (unk[i] != -99)
			{
				...
				if (IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0))
				{
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_71(i), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_71(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_71(i), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_71(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_71(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_71(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xAE75
{
	...
	bParam4;
	num = Global_2805029[empsParam0 /*3*/][func_107(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0xAEE5
{
	...
	{
		iParam2 == 0;
		unk = Global_2805029[empsParam0 /*3*/][func_107(iParam1)];
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10A8D
{
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_116(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_116(&Global_78341[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_177(var uParam0, int iParam1, int iParam2) // Position - 0x21FBC
{
	...
	else if (Global_78341[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_71(iParam1)) && Global_78341[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_71(iParam1)))
	{
		return true;
	}
...
void func_179(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x22254
{
	...
	else
	{
		...
		if (unk_0x76CD105BCAC6EB9F())
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_183(unk_0x259BE71D8A81D4FA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x259BE71D8A81D4FA(), 0) && !func_180() && !bParam4 && !bParam5 && !unk_0xAD15761928FCF79C())
...
void func_187(BOOL bParam0) // Position - 0x224EA
{
	...
	func_223();
	func_222(unk_0x4A8C381C258A124D(), -1631.3481f, -1112.6509f, 12.0206f);
...
void func_194(int iParam0) // Position - 0x23143
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_196() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113648.f_20566.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_196() /*5568*/].f_681.f_10), iParam0);
	}
...
void func_223() // Position - 0x23BEE
{
	...
	if (!func_56(iLocal_925[0]))
		iLocal_925[0] = unk_0x4E55EAB577C13329(joaat("prop_roller_car_01"), -1643.5242f, -1124.6805f, 17.4326f, 1, 1, 0);

	if (!func_56(iLocal_925[1]))
		iLocal_925[1] = unk_0x4E55EAB577C13329(joaat("prop_roller_car_02"), -1645.1455f, -1126.6127f, 17.4326f, 1, 1, 0);

	if (!func_56(iLocal_925[2]))
		iLocal_925[2] = unk_0x4E55EAB577C13329(joaat("prop_roller_car_02"), -1646.7676f, -1128.5453f, 17.4326f, 1, 1, 0);

	if (!func_56(iLocal_925[3]))
		iLocal_925[3] = unk_0x4E55EAB577C13329(joaat("prop_roller_car_02"), -1648.3896f, -1130.4784f, 17.4326f, 1, 1, 0);

	for (i = 0; i < iLocal_925; i = i + 1)
	{
		if (func_56(iLocal_925[i]))
		{
			unk_0x5C96CEA06531AB03(iLocal_925[i], 140f);
			unk_0x4285E11B28063EE0(iLocal_925[i], 1, 0);
			unk_0x44C48AC14D3C09ED(iLocal_925[i], 1, 0);
			unk_0x5D7CD709B34C90F0(iLocal_925[i], 1);
			unk_0x935364B4448CD584(iLocal_925[i], 1);
...
void func_228() // Position - 0x23EFE
{
	...
	if (!unk_0xB00920C3C99A34C5())
	{
		if (!Global_78558)
		{
			if (func_231() == 2 == false && !unk_0x76CD105BCAC6EB9F())
			{
