...
void main() // Position - 0x0
{
	...
	if (num == 17)
	{
		uLocal_97 = unk_0xA7B0B03284E7503C(unk61 - { 40f, 40f, 40f }, unk61 + { 40f, 40f, 40f }, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		else if (num == 19)
		{
			...
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && _DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]) && !unk_0x75E315E7679F4F24(num.f_28[0]) && unk_0x9F0C06CFBACDD6A1(uLocal_96) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_A", 0, -1) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_B", 0, -1) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_C", 0, -1))
				unk_0xBD618A73193F9982(uLocal_96, "DOM_BREATHING", num.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
		
			if (iLocal_95 == 0 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), unk61, num.f_15, num.f_15, num.f_15, 0, 0, 0))
			{
...
void func_151() // Position - 0xB3C3
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			if (func_152(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
int func_176(var uParam0) // Position - 0xC1E7
{
	if (*uParam0 == 18)
	{
		if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, 0, 1, 0))
		{
			...
			else if (!func_177(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_152(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 3f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_219(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE8D3
{
	...
	{
		if (func_233(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
{
	return func_224(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}
...
BOOL func_228(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEC5D
{
	...
	unk = { func_230(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_230(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };
...
BOOL func_237(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF06C
{
	...
	unk = { func_230(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
