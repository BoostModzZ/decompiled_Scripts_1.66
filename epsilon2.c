...
void func_1() // Position - 0x151
{
	...
	unk_0x696D2AC31CB5932A(iLocal_149, 241.3494f, 361.0303f, 105.9036f, &unk, &num);
	...
	switch (iLocal_148)
	{
		...
		case 1:
			...
			{
				if (!bLocal_153 && unk_0x1DD05E817C89C737() - uLocal_150 > 15000)
					if (func_35(1343538152, 6, 1, 60, 15000, 10000, -1, 0, -1, 0))
						bLocal_153 = true;
			
				if (!bLocal_155 && !unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 240.98317f, 358.86887f, 103.600464f, 246.0318f, 374.34146f, 109.65059f, 9f, 0, 1, 0))
				{
					if (!unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 240.98317f, 358.86887f, 103.600464f, 246.0318f, 374.34146f, 109.65059f, 9f, 0, 1, 0))
					{
						...
						if (unk_0x1D5CD3EAAA7422B0(num) <= 0.05f && !bLocal_155)
						{
							func_3(109, 6);
							func_3(109, 1);
							bLocal_154 = 1;
...
void func_49(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4D78
{
	...
	else
	{
		...
		if (unk_0x76CD105BCAC6EB9F())
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_54(unk_0x259BE71D8A81D4FA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x259BE71D8A81D4FA(), 0) && !func_50() && !bParam4 && !bParam5 && !unk_0xAD15761928FCF79C())
...
int func_62(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x524E
{
			...
			if (unk[i] != -99)
			{
				...
				if (IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0))
				{
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_72(i), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_72(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_72(i), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_72(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x80C1
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_83(unk_0x4B423FAA24E8ABF0(uParam0), 14, num, unk_0x6B7AEB5F3D578298(uParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_177(var uParam0, int iParam1, int iParam2) // Position - 0x232F1
{
	...
	else if (Global_78341[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_72(iParam1)) && Global_78341[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_72(iParam1)))
	{
		return true;
	}
...
BOOL func_211(int iParam0, int iParam1, int iParam2) // Position - 0x25E97
{
	...
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
	{
		...
		{
			if (!func_218(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), iParam1, 1, 1056964608, 0, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
...
BOOL func_232(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x26964
{
	...
	switch (Global_78813)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_234(0) || func_233(true))
			{
			}
			else
			{
...
BOOL func_282(var uParam0, int iParam1, int iParam2) // Position - 0x2BC84
{
	...
	else
	{
		...
		if (unk_0x1A4EFE92822E3123(uParam0, func_72(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, 0);
	}
...
void func_332(BOOL bParam0) // Position - 0x319B7
{
	...
	if (!func_353())
	{
		...
		{
			func_287(num, 1, 0);
			func_333(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_112735[num /*10*/].f_9 == -1)
