...
void main() // Position - 0x0
{
	...
	unk_0xF2CB0224D3BE0B42(&uLocal_52, 1);
		...
		if (bLocal_61)
		{
			if (iLocal_63 < 101)
			{
				if (SYSTEM::TIMERA() > 30)
				{
					...
					func_10("CELL_4005");
					unk_0x330108B080A2132F(iLocal_63);
...
void func_14() // Position - 0x695
{
	...
	func_10("CELL_4002");
	unk_0x330108B080A2132F(uLocal_20.f_24);
	func_10("CELL_4003");
...
{
	iLocal_51 = unk_0x6E5F2B4C6A398419();
	...
	TEXT_LABEL_ASSIGN_STRING(&(uLocal_20.f_25), unk_0xA9CB3A11303C5801(), 24);

	if (!unk_0x6BA487C862DB8DDF(&uLocal_20))
		TEXT_LABEL_ASSIGN_STRING(&uLocal_20, "CELL_195" /*Unknown*/, 64);

	if (!unk_0x6BA487C862DB8DDF(&(uLocal_20.f_16)))
	{
