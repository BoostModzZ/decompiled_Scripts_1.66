	...
	switch (iLocal_85)
	{
		...
		case 6:
			...
			if (!func_34(2))
			{
				...
				{
					unk_0xE226F16D30AF5945(uLocal_68, 200f, joaat("prop_mineshaft_door"), 0);
					func_33(2, true);
				}
			}
...
BOOL func_22(int iParam0) // Position - 0xA84
{
	...
	num2 = unk_0x8B5B2BE72A7C0CF6(Global_113648.f_10051.f_133, 0, num - 1);
...
{
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&iLocal_92, iParam0);
	else
		unk_0x8744D2E3FC95740E(&iLocal_92, iParam0);
...
void func_35() // Position - 0x14E3
{
	...
	switch (iLocal_72)
	{
		case 0:
			...
			{
				if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_51, uLocal_65, 1, 1, 0))
				{
					if (func_62())
					{
						iLocal_72 = 2;
		...
		case 1:
			...
			{
				if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_54, uLocal_65, 1, 1, 0))
				{
					func_54(0);
					iLocal_72 = 3;
					func_61(false, 800);
		...
		case 2:
			...
			{
				func_45(24, false);
				func_44(unk_0x4A8C381C258A124D(), uLocal_61, fLocal_64);
				...
				unk_0x4A3280817398D754(uLocal_61, 20f, 0);
				func_39(24, &uLocal_71);
				unk_0x74C1590CC91B3930(uLocal_71);
				iLocal_86 = unk_0x1DD05E817C89C737() + 40000;
			
				while (!unk_0x9E2D35FA908F57B4() || !unk_0xD0B0D1BD29678350(uLocal_71) && iLocal_86 > unk_0x1DD05E817C89C737())
				{
					SYSTEM::WAIT(0);
				}
				...
				{
					unk_0xBBB6D0F765409642(uLocal_71);
					func_44(unk_0x4A8C381C258A124D(), uLocal_57, fLocal_60);
					func_61(true, 800);
					iLocal_72 = 0;
				}
				else
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
		uLocal_82 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0) };
...
void func_84() // Position - 0x596B
{
	switch (iLocal_85)
	{
		...
		case 5:
			...
			uLocal_74 = unk_0x96A32328480B485C(joaat("DEFAULT_SCRIPTED_CAMERA"), -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
	...
	switch (iLocal_85)
	{
		...
		case 4:
			if (unk_0xFC8BFE4B41177C22(uLocal_78))
				unk_0xF09E30AF1B8FB379(&uLocal_78);
		...
		case 6:
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_77))
				unk_0xB3B56385ECA230B4(&uLocal_77);
		
			if (func_34(2))
				unk_0xC94AE68759E1B3BD(uLocal_68, 200f, joaat("prop_mineshaft_door"), 0);
			break;
	}
