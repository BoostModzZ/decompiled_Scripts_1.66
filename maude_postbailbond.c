...
void main() // Position - 0x0
{
	...
	while (true)
	{
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			...
			vector2 = { unk_0xD1A6A821F5AC81DB(uLocal_82, 1) };
			...
			switch (iLocal_87)
			{
				...
				case 2:
					if (!func_4(uLocal_82, joaat("SCRIPT_TASK_SMART_FLEE_PED")) && !unk_0xCA038E64C65D1F9D(uLocal_82))
						if (!unk_0x13CCB1AD131C1082(uLocal_82, func_11(), func_3(), 3))
							func_1();
					else
						func_56();
					break;
...
void func_1() // Position - 0x1B3
{
	...
	{
		func_2(&uLocal_82);
		unk_0xD844F5E50DAB6FF7(uLocal_82, unk_0x4A8C381C258A124D(), 10000f, -1, 0, 0);
		unk_0x44FB298D6382876D(uLocal_82, 1);
	}
...
{
	if (func_51(uLocal_82))
		if (!unk_0x912159A05BE6B52E(uLocal_82))
...
void func_24() // Position - 0x802
{
	if (unk_0xFC8BFE4B41177C22(uLocal_81))
		unk_0x5D7CD709B34C90F0(uLocal_81, 0);

	if (unk_0xFC8BFE4B41177C22(uLocal_80))
		unk_0x5D7CD709B34C90F0(uLocal_80, 0);
...
BOOL func_25(var uParam0, BOOL bParam1) // Position - 0x82A
{
	if (func_51(*uParam0))
	{
		...
		if (unk_0x27E68848F0E5D7D9(unk_0x4A8C381C258A124D()))
		{
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_80))
				if (unk_0x685171EED42BC4DF(unk_0x4A8C381C258A124D(), uLocal_80))
					return true;
		
			if (unk_0xFC8BFE4B41177C22(uLocal_81))
				if (unk_0x685171EED42BC4DF(unk_0x4A8C381C258A124D(), uLocal_81))
					return true;
		}
...
int func_43(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6, int iParam7) // Position - 0x11EB
{
	...
	if (iLocal_84 < iLocal_85)
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			...
			{
				if (unk_0x1DD05E817C89C737() - uLocal_83 > iParam6 + unk_0xC5935DFB3F39785A(0, 2000))
				{
					unk = 16;
...
void func_50() // Position - 0x1541
{
	...
	if (func_51(uLocal_82))
	{
		if (!unk_0x110821AE6C63DD4F(uLocal_82))
			unk_0xEE0BCDB1B5E36BCB(uLocal_82, 1, 0);
	
		unk_0xAAA71DD7E9059338(uLocal_82, 1);
		unk_0x886FA295C1257AAA(uLocal_82, 0);
		unk_0x3F58BFCF656F0DF1(uLocal_82, 0);
		unk_0x3CEA1FD137ACE2D9(uLocal_82, joaat("PLAYER"));
		unk_0x176A19E4589CC2C6(uLocal_82, 0);
		unk_0x828D385CED572E95(uLocal_82, 0);
		unk_0x0428AFDCAA63B06E(uLocal_82, 118, 0);
		unk = { 2728.33f, 4145.6f, 43.89f };
	
		if (unk_0xE10356B235A70E70(unk, 10f, joaat("prop_table_03b"), 0))
		{
			uLocal_80 = unk_0x8366ABB82B1ABC59(unk, 10f, joaat("prop_table_03b"), 1, 0, 1);
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_80))
			{
				unk_0xB2BD5837A8D3CEDA(uLocal_80, 2727.4f, 4145.56f, 43.68f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_80, -92.17f);
				unk_0x5D7CD709B34C90F0(uLocal_80, 1);
			}
		}
	
		if (unk_0xE10356B235A70E70(unk, 10f, joaat("prop_laptop_01a"), 0))
		{
			uLocal_81 = unk_0x8366ABB82B1ABC59(unk, 10f, joaat("prop_laptop_01a"), 0, 0, 1);
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81))
			{
				if (!unk_0x110821AE6C63DD4F(uLocal_81))
					unk_0xEE0BCDB1B5E36BCB(uLocal_81, 1, 0);
			
				unk_0xB2BD5837A8D3CEDA(uLocal_81, 2727.686f, 4145.715f, 44.08f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_81, 71f);
				unk_0x5D7CD709B34C90F0(uLocal_81, 1);
			}
		}
	
		if (unk_0xE10356B235A70E70(unk, 10f, joaat("prop_table_03_chr"), 0))
		{
			uLocal_79 = unk_0x8366ABB82B1ABC59(unk, 10f, joaat("prop_table_03_chr"), 0, 0, 1);
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_79))
			{
				...
				unk_0xB2BD5837A8D3CEDA(uLocal_79, 2728.35f, 4145.59f, 43.3f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_79, -91.28f);
			}
		}
	}
...
void func_56() // Position - 0x17B6
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_79))
	{
		...
		if (unk_0x13CCB1AD131C1082(uLocal_79, "special_ped@maude@base", "base_chair", 3))
		{
			unk_0x1D949F0AD44C7F05(uLocal_79, "base_chair", "special_ped@maude@base", -1000f);
			unk_0xC0086E5CBF13BBF7(uLocal_79, -1000f, 1);
		}
		else if (unk_0x13CCB1AD131C1082(uLocal_79, func_11(), "Female_Flee_Table_Left_Maude_Chair", 3))
		{
			unk_0x1D949F0AD44C7F05(uLocal_79, "Female_Flee_Table_Left_Maude_Chair", func_11(), -1000f);
			unk_0xC0086E5CBF13BBF7(uLocal_79, -1000f, 1);
		}
	}
	...
	{
		unk_0x44FB298D6382876D(uLocal_82, 1);
		unk_0x0428AFDCAA63B06E(uLocal_82, 118, 1);
	}
