...
void func_53() // Position - 0x1F3B
{
	...
	switch (iLocal_411)
	{
		case 0:
			...
			else if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_409) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
			{
				...
				if (func_58(unk_0x4A8C381C258A124D(), uLocal_409, 0) > num)
				{
					func_57();
		...
		case 1:
			...
			if (!func_60())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_409))
				{
					if (!unk_0xC450B06E5AAA0985(iLocal_410))
...
{
	if (unk_0xC450B06E5AAA0985(iLocal_410))
		unk_0xFE54B8568B2ABD12(&iLocal_410);
		...
		else
		{
			...
			if (uLocal_42.f_1.f_4 < uLocal_42.f_1.f_3)
			{
				if (bLocal_406)
				{
					...
					if (func_61())
						unk_0xF37CDE164C892195(uLocal_408, "SINGLE_BLIP_FROM_BOAT", unk4, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
					else
						unk_0xF37CDE164C892195(uLocal_408, "SCRIPT_TRIGGERED_FROM_PROP", unk, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
				}
				else
				{
					...
					{
						uLocal_392 = unk_0x339BF323C4261E69(unk4, fLocal_403);
					...
					if (func_61())
					{
						for (i = 0; i <= 3; i = i + 1)
						{
							if (!unk_0xC450B06E5AAA0985(uLocal_393[i]))
							{
								uLocal_393[i] = unk_0x339BF323C4261E69(unk4, fLocal_403 + uLocal_398[i]);
								unk_0xF42EBD7CD0682A8B(uLocal_393[i], 255);
								unk_0x61183D6239A9D7B8(uLocal_393[i], 4);
								unk_0x360B279488A775FC(uLocal_393[i], 1);
								unk_0x641FCCDF2824DCFD(uLocal_393[i], 1);
								unk_0x89FE619BFBB2024B(uLocal_393[i], 0);
							}
							else
							{
								unk_0x5D3946F818C6B331(uLocal_393[i], fLocal_403 + uLocal_398[i]);
							}
						}
					}
					else
					{
						...
						{
							if (unk_0xC450B06E5AAA0985(uLocal_393[i]))
								unk_0x5D3946F818C6B331(uLocal_393[i], fLocal_403);
						}
					}
...
void func_64() // Position - 0x263A
{
	...
	{
		if (unk_0xC450B06E5AAA0985(uLocal_393[i]))
			unk_0xFE54B8568B2ABD12(&uLocal_393[i]);
	}
