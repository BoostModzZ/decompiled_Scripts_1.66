...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x76CD105BCAC6EB9F() && _NETWORK_IS_PLAYER_VALID(unk_0x259BE71D8A81D4FA(), true, true) && !Global_1836384 && Global_32163 == 0)
			func_113();
	...
	if (unk_0x6252BC0DD8A320DB(iParam0))
	{
		if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		{
			if (unk_0xFC8BFE4B41177C22(uLocal_68))
			{
				...
				{
					if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), uLocal_68, 0))
					{
						unk = { unk_0xD1A6A821F5AC81DB(uLocal_68, 1) };
						num = unk_0xCFC0C995455A6204(uLocal_68);
						unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), unk, unk.f_1, unk.f_2 + 4f, 1, 0, 0, 1);
						flag = true;
					}
				}
			
				unk_0x8C1F7D7A31B2A38E(&uLocal_68);
			}
			...
			{
				uLocal_68 = unk_0x5779387E956077A6(iParam0, unk, num, 0, 1, 0);
				unk_0x1DE99C193C7EC64B(uLocal_68, 1084227584);
				unk_0x55098D9E9AD58806(iParam0);
				unk_0x68298CA6191CDFDB(&uLocal_68);
				func_16(sLocal_70);
				func_5(20);
			}
			else
...
void func_31(int iParam0, BOOL bParam1) // Position - 0xBD2
{
	if (bParam1)
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_32413, iParam0);
		func_5(iParam0);
	}
	else
	{
		unk_0x8744D2E3FC95740E(&Global_32413, iParam0);
	}
...
void func_39() // Position - 0xFFF
{
	...
	switch (iLocal_62)
	{
		...
		case 5:
			...
			iLocal_75 = unk_0x1DD05E817C89C737() - uLocal_74;
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x3BC7
{
	if (IS_BIT_SET(Global_32415, iParam0))
	{
		if (iParam1 != 0)
		{
			...
			{
				unk_0x8744D2E3FC95740E(&Global_32415, iParam0);
				bLocal_93 = true;
				return true;
			}
			else
...
void func_108() // Position - 0x3C2F
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (uLocal_80[i] != -1)
		{
			unk_0xFE3A52C5B7AE3101(uLocal_80[i]);
			uLocal_80[i] = -1;
		}
	}
