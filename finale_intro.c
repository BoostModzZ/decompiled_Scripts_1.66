...
BOOL func_25(int iParam0) // Position - 0x3FAE
{
	...
	if (!func_26(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger") && !flag)
		return false;
...
BOOL func_27(var uParam0) // Position - 0x405C
{
...
BOOL func_28(var uParam0) // Position - 0x408B
{
...
BOOL func_29(var uParam0) // Position - 0x413C
{
	int num;
...
BOOL func_32(var uParam0, BOOL bParam1) // Position - 0x423C
{
	switch (unk_0x4B423FAA24E8ABF0(uParam0))
	{
...
int func_33(var uParam0) // Position - 0x4297
{
	int i;
...
BOOL func_34(int iParam0, int iParam1) // Position - 0x42D0
{
	if (iParam1 == 0)
...
BOOL func_43(int iParam0, int iParam1) // Position - 0x47D7
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_47(int iParam0, BOOL bParam1, var uParam2) // Position - 0x4CBC
{
	BOOL flag;
...
BOOL func_48(int iParam0) // Position - 0x5108
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_49(var uParam0, eCharacter echParam1) // Position - 0x5131
{
	var unk;
	int i;
	int j;
...
void func_50(var uParam0, var uParam1) // Position - 0x5333
{
	int i;
...
BOOL func_54(var uParam0) // Position - 0x575F
{
...
BOOL func_55(int iParam0) // Position - 0x583C
{
	if (iParam0 == 0)
		return false;
...
BOOL func_56(int iParam0, BOOL bParam1, int iParam2) // Position - 0x59EE
{
	int i;
	var unk;
...
BOOL func_57(int iParam0) // Position - 0x5B70
{
	int num;
	var unk;
	var unk2;
...
BOOL func_59(int iParam0, int iParam1) // Position - 0x5C53
{
	BOOL num;
	var unk;
...
BOOL func_67(var uParam0) // Position - 0x939E
{
	int num;
	var unk;
...
BOOL func_68(var uParam0) // Position - 0x93E5
{
	int i;
...
BOOL func_69(var uParam0) // Position - 0x9461
{
	int i;
...
eCharacter func_70(var uParam0) // Position - 0x9549
{
	int i;
...
BOOL func_71(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x95AC
{
	int i;
	var unk;
	int num;
...
void func_73(var uParam0, eCharacter echParam1) // Position - 0x96F3
{
	int i;
...
BOOL func_75(var uParam0) // Position - 0x97A0
{
...
BOOL func_77(var uParam0) // Position - 0x9989
{
	int i;
	int num;
	int num2;
...
int func_79(var uParam0, int iParam1) // Position - 0x9ABC
{
	int value;
	int value2;
	float num;
...
int func_80(var uParam0, int iParam1) // Position - 0x9BA5
{
	int i;
...
BOOL func_81(var uParam0, int iParam1, int iParam2) // Position - 0x9C07
{
...
void func_88(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x9FCB
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0xA50F
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xA54C
{
...
int func_95(eCharacter echParam0) // Position - 0xA571
{
	return Global_2028[echParam0 /*29*/];
}

BOOL func_96(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0xA580
{
	float num;
	var unk3;
	var unk6;
...
void func_99(var uParam0) // Position - 0xA969
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_102(int iParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0xAA15
{
	var unk;
	float num;
...
void func_104(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xAA96
{
	int i;
...
int func_114(eCharacter echParam0, int iParam1) // Position - 0xC58E
{
	int num;
...
BOOL func_115(var uParam0, eCharacter echParam1, int iParam2) // Position - 0xC5D0
{
	int i;
...
int func_122(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCD5F
{
	var unk;
	int i;
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xD3B7
{
	int num;
...
BOOL func_141(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x108F6
{
	int num;
	int num2;
	eMPStat stat;
...
BOOL func_199(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x246B7
{
	int num;
...
int func_200(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x249BE
{
	int num;
	int num2;
	int num3;
...
void func_204(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x24C91
{
	eCharacter character;
...
void func_205(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x251DA
{
	eCharacter character;
