...
void main() // Position - 0x0
{
	...
	uLocal_94 = unk_0xA0A2925EDC6DDA6D(joaat("WEAPON_SNIPERRIFLE"));
	uLocal_95 = unk_0xB39F6B1C186F538E(joaat("COMPONENT_AT_SCOPE_LARGE"));
	uLocal_96 = unk_0xB39F6B1C186F538E(joaat("COMPONENT_AT_AR_SUPP_02"));
	...
	while (true)
	{
		...
		if (func_174(&num, 0) && unk_0x1D5CD3EAAA7422B0(vector.f_2 - vector2.f_2) < 2.5f)
		{
			if (!func_2(&num))
				func_265(&num, true);
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_188() || Global_32166 || func_187() || func_186(8, -1) || func_184() || func_96() || func_185() || func_183() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_188() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_186(8, -1) || func_183() || func_182() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
int func_189(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCD81
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_193(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void func_194(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCF6F
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_193(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_197(uParam0, 1);
			}
			else
			{
				...
				if (func_193(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_199(uParam0);
			}
		}
	}
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_214(var uParam0, int iParam1) // Position - 0xE158
{
	...
	{
		if (func_225(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
{
	return func_216(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}
...
BOOL func_220(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE4E2
{
	...
	unk = { func_222(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_222(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };
...
BOOL func_229(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE8F1
{
	...
	unk = { func_222(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_241(var uParam0) // Position - 0xECA3
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&num) || !unk_0xE100DD4F82A51BDE("rcmhunting2"))
				return false;
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uLocal_100))
			{
				uLocal_100 = unk_0x8A3572575D91006C(joaat("WEAPON_SNIPERRIFLE"), 0, uLocal_97, 0, 1065353216, 0, 0, 1);
				unk_0x93A0B91D4456D7E9(uLocal_100, joaat("COMPONENT_AT_SCOPE_LARGE"));
				unk_0x93A0B91D4456D7E9(uLocal_100, joaat("COMPONENT_AT_AR_SUPP_02"));
			}
		...
		case 3:
			...
			if (unk_0xE10356B235A70E70(uLocal_97, 1f, uLocal_94, 0))
				unk_0xCF39804E8C88080E(uLocal_100, 0f, -90f, -162.64f, 2, 1);
...
BOOL func_249(var uParam0) // Position - 0xF17D
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&num) || !func_250(&(uParam0->f_48)) || !unk_0xE100DD4F82A51BDE("special_ped@cletus@base"))
				return false;
