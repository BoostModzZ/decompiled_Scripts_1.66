...
BOOL func_2() // Position - 0x10E
{
	...
	if (!unk_0xD6F9DEE4765092A9(&uLocal_90))
	{
		if (!unk_0x9CFFB7009B578840(uLocal_87))
		{
			unk = { { 32.856f, 3819.65f, 1971.62f } - uLocal_83 };
			uLocal_87 = unk_0x56E8A6AA712B10C2(&uLocal_90, uLocal_83 + unk, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}

	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		if (unk_0x13CCB1AD131C1082(unk_0x4A8C381C258A124D(), &uLocal_143, &uLocal_159, 2))
		{
			...
			switch (iLocal_224)
			{
				case 0:
					...
					if (num > fLocal_141)
					{
						if (!unk_0xFC8BFE4B41177C22(uLocal_72) || iLocal_89 != -1)
						{
							if (unk_0x5B5B2AE530F511CC(&uLocal_106, unk_0x4A8C381C258A124D(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_89, 1f, 0, 0, 0))
							{
								if (unk_0x1B79E937E91F40C3(&uLocal_106, "scr_meth_pipe_smoke"))
									func_17(unk_0x4A8C381C258A124D(), 0, 1, 0, -1);
							
								uLocal_223 = unk_0xCA369FBC0DE29517();
								unk_0xBD618A73193F9982(uLocal_223, &uLocal_207, unk_0x4A8C381C258A124D(), &uLocal_191, 0, 0);
								iLocal_224 = iLocal_224 + 1;
							}
						}
						else if (unk_0xDD19F75405614D3C(&uLocal_106, uLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0))
						{
							if (unk_0x1B79E937E91F40C3(&uLocal_106, "scr_meth_pipe_smoke"))
								func_17(unk_0x4A8C381C258A124D(), 0, 1, 0, -1);
				...
				case 2:
					if (!unk_0xD6F9DEE4765092A9(&uLocal_122))
						if (unk_0xE56FEB6B12B5A32C(&uLocal_122, uLocal_83 + uLocal_138, 0f, 0f, 0f, 1f, 0, 0, 0))
							iLocal_224 = iLocal_224 + 1;
					else
						iLocal_224 = iLocal_224 + 1;
					break;
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_72))
				if (unk_0xA3736D76B0E93E93(uLocal_72))
					if (iLocal_82 != -1)
						if (num > fLocal_81)
		...
		else
		{
			if (iLocal_88 != 0)
			{
				unk_0x182120534CCF9023(iLocal_88, 0);
				iLocal_88 = 0;
				unk_0x8E4825CCACA34B58(uLocal_223);
				unk_0x394AFAC073E1F277(uLocal_223);
			}
			...
			if (func_6(num, &unk31, &unk47, &unk63))
				if (func_4(num, &unk64, &unk80, &unk96, &unk112, &unk113))
					if (!unk_0x13CCB1AD131C1082(*uParam0, &unk64, &unk31, 2))
						unk_0x381D671BCFC294D9(*uParam0, Global_98011, &unk31, &unk64, 1000f, -8f, unk63, 1148846080);
...
BOOL func_37() // Position - 0x2D8D
{
	if (!(iLocal_73 == 0))
	{
		if (!unk_0xFC8BFE4B41177C22(uLocal_72))
		{
			...
			{
				uLocal_72 = unk_0x4E55EAB577C13329(iLocal_73, uLocal_83, 1, 1, 0);
				unk_0x4D306DD94DD6FDBA(uLocal_72, unk_0x4A8C381C258A124D(), unk_0x72F7E39FB49FC0BA(unk_0x4A8C381C258A124D(), iLocal_80), uLocal_74, uLocal_77, 0, 0, 0, 0, 2, 1, 0);
			}
			else
			{
				uLocal_72 = unk_0x4E55EAB577C13329(iLocal_73, uLocal_83 + uLocal_74, 1, 1, 0);
				unk_0xB2BD5837A8D3CEDA(uLocal_72, uLocal_83 + uLocal_74, 1, 0, 0, 1);
				unk_0xCF39804E8C88080E(uLocal_72, { fLocal_86, 0f, 0f } + uLocal_77, 2, 1);
				unk_0x5D7CD709B34C90F0(uLocal_72, 1);
			}
		}
	}
	...
	if (!func_38())
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_72))
			if (iLocal_80 != -1)
				if (!unk_0x21478251925DBFD7(uLocal_72, unk_0x4A8C381C258A124D()))
					unk_0x4D306DD94DD6FDBA(uLocal_72, unk_0x4A8C381C258A124D(), unk_0x72F7E39FB49FC0BA(unk_0x4A8C381C258A124D(), iLocal_80), uLocal_74, uLocal_77, 0, 0, 0, 0, 2, 1, 0);
...
void func_53() // Position - 0x3214
{
	...
	while (!flag && num < 400)
	{
		...
		if (!unk_0xD6F9DEE4765092A9(&uLocal_175))
			if (!unk_0x91476A70AA1CB09A(&uLocal_175, 0, -1))
				flag = false;
