...
void func_189(var uParam0) // Position - 0xCD12
{
	...
	if (unk_0x1DD05E817C89C737() - uLocal_98 > 1250)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !unk_0xCB5CAFF0A4A8B74B(uParam0->f_28[0]))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && !func_190(unk_0x4A8C381C258A124D(), uParam0->f_28[0], 50f, 1))
			{
		...
		uLocal_98 = unk_0x1DD05E817C89C737();
	}
...
void func_191() // Position - 0xCE1D
{
	...
	unk_0x6D16B99FEB0AFFF1(uLocal_96, num, num2, num3, num4, 100, 100, 100, 255, 0);
...
int func_192(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xCF0F
{
	...
	if (!(*uParam8 == 3))
	{
		if (func_180(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && func_199(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
			...
			else if (func_194(sParam5))
			{
				if (!(*uParam8 == 1))
				{
					...
					{
						if (func_199(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
						{
			...
			if (func_199(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f && *uParam8 == 1)
			{
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_220(var uParam0, int iParam1) // Position - 0xE3D1
{
	...
	{
		if (func_231(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
{
	return func_222(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}
...
BOOL func_226(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE75B
{
	...
	unk = { func_228(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_228(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };
...
BOOL func_235(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB6A
{
	...
	unk = { func_228(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
