...
BOOL func_2() // Position - 0x108
{
	...
	num = SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_82);
...
void func_20() // Position - 0x54F
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_77; i = i + 1)
		{
			if (iLocal_77[i] != 0)
			{
				unk_0xEC9DAA34BBB4658C(iLocal_77[i]);
			
				if (!unk_0x6252BC0DD8A320DB(iLocal_77[i]))
				{
					unk_0xEC9DAA34BBB4658C(iLocal_77[i]);
					flag = false;
				}
		...
		if (!unk_0xD6F9DEE4765092A9(&uLocal_117))
		{
			unk_0x80813AC549A1E8AE(&uLocal_117);
		
			if (!unk_0xE100DD4F82A51BDE(&uLocal_117))
			{
				unk_0x80813AC549A1E8AE(&uLocal_117);
				flag = false;
			}
	...
	for (i = 0; i < iLocal_72; i = i + 1)
	{
		if (iLocal_77[i] != 0)
		{
			iLocal_72[i] = unk_0xB1DBFEB95C0EFB88(26, iLocal_77[i], uLocal_82 + uLocal_86[i /*3*/], 0, 1, 1);
			unk_0xCF39804E8C88080E(iLocal_72[i], { fLocal_85, 0f, 0f } + uLocal_99[i /*3*/], 2, 1);
			unk_0xC6E8E1D693021E9E(iLocal_72[i], 0);
		
			if (iLocal_70 == 288)
			{
				unk_0xD1C578C204015E1F(iLocal_72[i], 3, 1, 0, 0);
				unk_0xD1C578C204015E1F(iLocal_72[i], 4, 0, 0, 0);
			}
			else
			{
				unk_0xC6E8E1D693021E9E(iLocal_72[i], 0);
			...
			unk_0xBE8796DB2B90A437(iLocal_72[i], 13, 0);
			unk_0xBE8796DB2B90A437(iLocal_72[i], 17, 1);
			unk_0xAAA71DD7E9059338(iLocal_72[i], 1);
			unk_0x3F58BFCF656F0DF1(iLocal_72[i], 0);
			unk_0x9F5225AA1E102B7A(iLocal_72[i], &uLocal_117, &uLocal_125[i /*8*/], uLocal_82 + uLocal_86[i /*3*/], { fLocal_85, 0f, 0f } + uLocal_99[i /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
			unk_0xD8ED11B32DF72E0B(iLocal_72[i], 0, 0);
			unk_0x44FB298D6382876D(iLocal_72[i], 1);
			unk_0x0FB8E752BCC547A9(iLocal_72[i], 55, 1);
		
			if (uLocal_166[i] > 0)
			{
				unk_0x07D31B8F40A98A75(iLocal_72[i], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x83707FFC4BC486A1(iLocal_72[i], 1, 0.81f, 0.733f, 4);
				unk_0x83707FFC4BC486A1(iLocal_72[i], 0, 0.94f, 0.59f, 3);
				unk_0x83707FFC4BC486A1(iLocal_72[i], 3, 0.24f, 0.62f, 4);
				unk_0x83707FFC4BC486A1(iLocal_72[i], 2, 0f, 0.15f, 2);
				unk_0x83707FFC4BC486A1(iLocal_72[i], 5, 0.46f, 0.853f, 3);
				unk_0x83707FFC4BC486A1(iLocal_72[i], 4, 0.308f, 0.786f, 3);
				unk_0xD1D8E1BF0769890C(iLocal_72[i], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xD1D8E1BF0769890C(iLocal_72[i], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xD1D8E1BF0769890C(iLocal_72[i], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xD1D8E1BF0769890C(iLocal_72[i], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xD1D8E1BF0769890C(iLocal_72[i], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
	}
	...
	for (i = 0; i < iLocal_159; i = i + 1)
	{
		if (uLocal_166[i] > 0)
		{
			...
			num7 = 1f;
			num8 = -1f;
			iLocal_159[i] = unk_0x0153AEF89004E87C(uLocal_166[i], uLocal_82 + uLocal_173[i /*3*/], unk, unk4, num2, num3, num4, num5, num6, num7, num8, 0, 0, 0);
			SYSTEM::WAIT(0);
		}
	}
...
void func_22() // Position - 0x916
{
	...
	switch (iLocal_70)
	{
		case 280:
			...
			uLocal_173[4 /*3*/] = { ((uLocal_173[0 /*3*/] + uLocal_173[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, unk_0xD2AA6F822D3A55D2(0.5f, 0.5f), unk_0xD2AA6F822D3A55D2(0.5f, 0.5f) } };
			uLocal_173[5 /*3*/] = { ((uLocal_173[1 /*3*/] + uLocal_173[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, unk_0xD2AA6F822D3A55D2(0.5f, 0.5f), unk_0xD2AA6F822D3A55D2(0.5f, 0.5f) } };
			break;
...
void func_34() // Position - 0x91FB
{
	...
	{
		if (iLocal_77[i] != 0)
			unk_0x55098D9E9AD58806(iLocal_77[i]);
	}

	if (!unk_0xD6F9DEE4765092A9(&uLocal_117))
		unk_0x268BE77F77533D03(&uLocal_117);

	for (i = 0; i < iLocal_159; i = i + 1)
	{
		unk_0x1A22029316A4B46C(iLocal_159[i]);
	}
