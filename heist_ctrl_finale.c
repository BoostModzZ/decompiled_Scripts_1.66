...
BOOL func_333(int iParam0) // Position - 0x1F81C
{
	...
	if (!func_334(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger") && !flag)
		return false;
...
BOOL func_335(int iParam0) // Position - 0x1F8C6
{
...
BOOL func_336(int iParam0) // Position - 0x1F8F5
{
...
BOOL func_337(int iParam0) // Position - 0x1F9A6
{
	int num;
...
BOOL func_338(int iParam0) // Position - 0x1FA1D
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_340(var uParam0, BOOL bParam1) // Position - 0x1FAA6
{
...
int func_341(var uParam0) // Position - 0x1FB01
{
	int i;
...
BOOL func_342(int iParam0, int iParam1) // Position - 0x1FB3A
{
	if (iParam1 == 0)
...
BOOL func_351(int iParam0, int iParam1) // Position - 0x20044
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_355(int iParam0, BOOL bParam1, var uParam2) // Position - 0x20529
{
	BOOL flag;
...
BOOL func_356(int iParam0) // Position - 0x20975
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_357(int iParam0, eCharacter echParam1) // Position - 0x2099E
{
	int i;
...
BOOL func_359(var uParam0) // Position - 0x20A4B
{
...
BOOL func_361(var uParam0) // Position - 0x20C34
{
	int i;
	int num;
	int num2;
...
int func_363(var uParam0, int iParam1) // Position - 0x20D67
{
	int value;
	int value2;
	float num;
...
int func_364(var uParam0, int iParam1) // Position - 0x20E50
{
	int i;
...
BOOL func_365(var uParam0, int iParam1, int iParam2) // Position - 0x20EB2
{
...
void func_369(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x20F4A
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_371(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x2136A
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_376(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x217CF
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x218FB
{
...
void func_381(var uParam0, int iParam1, var uParam2, float fParam3, int iParam4, var uParam5) // Position - 0x219FC
{
	int num;
	int num2;
	eCharacter character;
...
void func_382(var uParam0, int iParam1, int iParam2, var uParam3, float fParam4, int iParam5, var uParam6, int iParam7) // Position - 0x21ACF
{
	eCharacter character;
	int i;
	Vector3 vector;
...
BOOL func_383(var uParam0, int iParam1, int iParam2) // Position - 0x21FD6
{
	int num;
