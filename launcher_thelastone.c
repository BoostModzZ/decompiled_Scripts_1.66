...
int func_189(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xCCE2
{
	...
	if (func_180(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_195(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
			{
				unk = 16;
		...
		else if (func_190(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
				if (func_195(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
					func_149();
		}
	}
...
void func_196(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xCF4E
{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam2))
		{
			...
			{
				if (func_195(unk_0x4A8C381C258A124D(), uParam3, 1) <= 100f)
					func_199(uParam0, 1);
			}
			else
			{
				...
				{
					num = func_195(unk_0x4A8C381C258A124D(), fParam6, 1);
					num2 = func_195(unk_0x4A8C381C258A124D(), fParam9, 1);
					num3 = num - num2;
				...
				if (func_195(unk_0x4A8C381C258A124D(), uParam3, 1) > 120f)
					func_200(uParam0);
			}
		}
	}
...
BOOL func_243(var uParam0) // Position - 0xEC87
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_246(&num) || !unk_0xE100DD4F82A51BDE("rcmlastone1") || !unk_0x92A65766A892EFC6(joaat("WEAPON_PUMPSHOTGUN")) || !unk_0x92A65766A892EFC6(joaat("WEAPON_SNIPERRIFLE")))
				return false;
		...
		case 2:
			flag = true;
			uParam0->f_28[0] = unk_0xB1DBFEB95C0EFB88(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
