...
BOOL func_133(int iParam0) // Position - 0x7813
{
	...
	if (!func_134(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger") && !flag)
		return false;
...
BOOL func_135(var uParam0) // Position - 0x78BD
{
...
BOOL func_136(var uParam0) // Position - 0x78EC
{
...
BOOL func_137(var uParam0) // Position - 0x799D
{
	int num;
...
BOOL func_138(int iParam0) // Position - 0x7A14
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_140(var uParam0, BOOL bParam1) // Position - 0x7A9D
{
	switch (unk_0x4B423FAA24E8ABF0(uParam0))
	{
...
int func_141(var uParam0) // Position - 0x7AF8
{
	int i;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x7B31
{
	if (iParam1 == 0)
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x803A
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_155(int iParam0, BOOL bParam1, var uParam2) // Position - 0x851F
{
	BOOL flag;
...
BOOL func_156(int iParam0) // Position - 0x896B
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_157(var uParam0, eCharacter echParam1) // Position - 0x8994
{
	var unk;
	int i;
	int j;
...
void func_158(var uParam0, var uParam1) // Position - 0x8B96
{
	int i;
...
BOOL func_162(var uParam0) // Position - 0x8FC1
{
...
BOOL func_163(int iParam0) // Position - 0x909E
{
	if (iParam0 == 0)
		return false;
...
BOOL func_164(int iParam0, BOOL bParam1, int iParam2) // Position - 0x9250
{
	int i;
	var unk;
...
BOOL func_165(int iParam0) // Position - 0x93D2
{
	int num;
	var unk;
	var unk2;
...
BOOL func_167(int iParam0, int iParam1) // Position - 0x94B5
{
	BOOL num;
	var unk;
...
BOOL func_175(var uParam0) // Position - 0xCBFF
{
	int num;
	var unk;
...
BOOL func_176(var uParam0) // Position - 0xCC46
{
	int i;
...
BOOL func_177(var uParam0) // Position - 0xCCC2
{
	int i;
...
eCharacter func_178(var uParam0) // Position - 0xCDAA
{
	int i;
...
BOOL func_179(var uParam0, int iParam1, BOOL bParam2) // Position - 0xCE0D
{
	int i;
	var unk;
	int num;
...
void func_181(var uParam0, eCharacter echParam1) // Position - 0xCF53
{
	int i;
...
BOOL func_183(var uParam0) // Position - 0xD000
{
...
BOOL func_185(var uParam0) // Position - 0xD1E9
{
	int i;
	int num;
	int num2;
...
int func_187(var uParam0, int iParam1) // Position - 0xD31C
{
	int value;
	int value2;
	float num;
...
int func_188(var uParam0, int iParam1) // Position - 0xD405
{
	int i;
...
BOOL func_189(var uParam0, int iParam1, int iParam2) // Position - 0xD467
{
...
int func_194(eCharacter echParam0, int iParam1) // Position - 0xD7CF
{
	int num;
...
void func_195(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xD811
{
	int i;
...
var func_205(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF307
{
	return func_206(&(Global_107196.f_2890), uParam0, fParam3, false);
}

var func_206(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF321
{
	var unk;
	Vector3 vector;
	BOOL flag;
...
int func_207(var uParam0) // Position - 0xF5D3
{
	int i;
	var unk;
	var unk2;
...
BOOL func_208(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xF696
{
	int num;
	var unk;
	int num2;
...
BOOL func_209(var uParam0, var uParam1, BOOL bParam2) // Position - 0xF89E
{
	var unk;
	var unk2;
	var unk3;
...
void func_210(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF8FF
{
	int num;
	int num2;
	int i;
...
void func_216(var uParam0, var uParam1) // Position - 0x100F2
{
	int num;
	int num2;
...
BOOL func_218(var uParam0) // Position - 0x1017B
{
	int num;
...
BOOL func_221(var uParam0) // Position - 0x10236
{
...
int func_222(var uParam0) // Position - 0x102BD
{
...
BOOL func_225(int iParam0, BOOL bParam1) // Position - 0x1032C
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x1038A
{
	var unk;
...
BOOL func_235(int iParam0) // Position - 0x105B3
{
	switch (iParam0)
	{
		case joaat("police"):
...
BOOL func_238(int iParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x1063C
{
	var unk;
	float num;
...
void func_250(var uParam0, var uParam1, var uParam2) // Position - 0x10AAF
{
...
BOOL func_253(var uParam0) // Position - 0x10B3C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x117E7
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x11817
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
BOOL func_306(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1584E
{
	int num;
	int num2;
	eMPStat stat;
