			...
			switch (iLocal_142)
			{
				...
				case 2:
					if (unk_0xFD216000DC314A92())
					{
						...
						{
							func_219(unk_0x4A8C381C258A124D(), 1974.513f, 3814.579f, 32.4266f, 270f, false, 1);
...
void func_210(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26D28
{
	...
	else
	{
		...
		if (unk_0x76CD105BCAC6EB9F())
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_214(unk_0x259BE71D8A81D4FA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x259BE71D8A81D4FA(), 0) && !func_211() && !bParam4 && !bParam5 && !unk_0xAD15761928FCF79C())
...
BOOL func_226(int iParam0, int iParam1, int iParam2) // Position - 0x272C6
{
	...
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
	{
		...
		{
			if (!func_233(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), iParam1, 1, 1056964608, 0, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
...
BOOL func_247(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x27D6A
{
	...
	switch (Global_78813)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_249(0) || func_248(true))
			{
			}
			else
			{
...
void func_269(BOOL bParam0) // Position - 0x284DE
{
	...
	if (!func_290())
	{
		...
		{
			func_161(num, 1, 0);
			func_270(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_112735[num /*10*/].f_9 == -1)
...
BOOL func_271(char* sParam0, int iParam1, int iParam2) // Position - 0x285D6
{
	...
	if (func_277())
	{
		...
		{
			num = func_272(unk_0x1AF90EB93E0012D6());
