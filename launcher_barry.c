...
void main() // Position - 0x0
{
	...
	if (num == 4)
	{
		...
		uLocal_271 = unk_0x1DD05E817C89C737();
	}
	...
	while (true)
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_208(&num, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_207(&num, uLocal_97, true, 0);
			else if (num == 3)
				func_208(&num, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_193(&uLocal_105, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
	
		num2 = 0;
	
		if (func_192(num))
		{
			if (unk_0x1DD05E817C89C737() - uLocal_94 > 5000)
			{
				num2 = 1;
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD326
{
	...
	{
		case 0:
			if (unk_0x1DD05E817C89C737() - uLocal_271 > 5000)
				*uParam0 = 1;
			break;
		...
		case 2:
			...
			else if (func_206(unk_0x4A8C381C258A124D(), uParam1, 1) >= 25f)
			{
				func_148();
				*uParam0 = 0;
			}
...
BOOL func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDB28
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_206(unk_0x4A8C381C258A124D(), uParam1, 1) < fParam9)
	{
		unk = 16;
...
void func_257() // Position - 0xF8F9
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
		if (func_258(unk_0x4A8C381C258A124D(), unk, num, 1))
			func_155();
