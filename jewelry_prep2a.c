...
BOOL func_227(int iParam0) // Position - 0x10F88
{
	...
	if (!func_228(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger") && !flag)
		return false;
...
BOOL func_229(var uParam0) // Position - 0x11032
{
...
BOOL func_230(var uParam0) // Position - 0x11061
{
...
BOOL func_231(var uParam0) // Position - 0x11112
{
	int num;
...
BOOL func_232(int iParam0) // Position - 0x11189
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_234(var uParam0, BOOL bParam1) // Position - 0x11212
{
	switch (unk_0x4B423FAA24E8ABF0(uParam0))
	{
...
int func_235(var uParam0) // Position - 0x1126D
{
	int i;
...
BOOL func_236(int iParam0, int iParam1) // Position - 0x112A6
{
	if (iParam1 == 0)
...
BOOL func_245(int iParam0, int iParam1) // Position - 0x117AD
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_249(int iParam0, BOOL bParam1, var uParam2) // Position - 0x11C92
{
	BOOL flag;
...
BOOL func_250(int iParam0) // Position - 0x120DE
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_251(var uParam0, eCharacter echParam1) // Position - 0x12107
{
	int i;
...
BOOL func_253(var uParam0) // Position - 0x121B4
{
...
BOOL func_255(var uParam0) // Position - 0x1239D
{
	int i;
	int num;
	int num2;
...
int func_257(var uParam0, int iParam1) // Position - 0x124D0
{
	int value;
	int value2;
	float num;
...
int func_258(var uParam0, int iParam1) // Position - 0x125B9
{
	int i;
...
BOOL func_259(var uParam0, int iParam1, int iParam2) // Position - 0x1261B
{
...
void func_262(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x12689
{
	int num;
	int num2;
	int i;
...
void func_268(var uParam0, var uParam1) // Position - 0x12E78
{
	int num;
	int num2;
...
BOOL func_270(var uParam0) // Position - 0x12F01
{
	int num;
...
BOOL func_273(var uParam0) // Position - 0x12FBC
{
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
...
int func_274(var uParam0) // Position - 0x13043
{
...
BOOL func_277(int iParam0, BOOL bParam1) // Position - 0x130B2
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x13110
{
	var unk;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x13A14
{
...
void func_290(var uParam0, int iParam1) // Position - 0x13AAF
{
...
int func_295(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x13EA4
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0x150B8
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
			return true;
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x151EE
{
	var unk;
...
BOOL func_321(var uParam0, int iParam1, BOOL bParam2) // Position - 0x1608D
{
	int num;
...
float func_322(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0x160D3
{
	var unk;
